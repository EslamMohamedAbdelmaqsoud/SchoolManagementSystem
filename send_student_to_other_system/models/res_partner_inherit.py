...
class res_partner_inherit(models.Model):
    ...
    # authenticate with db to get cookies for further requests to the db server using the cookies
    ...
    # override create method to send student data to other systems when a student is created in odoo system
    @api.model
